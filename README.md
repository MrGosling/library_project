...
раздача статики через **nginx** (с проксированием `/api` на бэкенд).
...
Фронтенд поднимается вместе со всем проектом командой `docker compose up -d --build`
и доступен на http://localhost:3000.
